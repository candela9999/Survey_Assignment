...
Now model with those vars... This is pretty uninterpretable. Not sure we include it... But did a logisitic model to see if anything was very correlated. 
...
# the best model is the one without age
na_model <- glm(target_NA ~ lgb_discri + I(age * age) + antilgbtq_rights + internet_use + 
    social_class + country_name,
                      data = dk_target, 
                      family = "binomial")
summary(na_model)
broom::tidy(na_model)
